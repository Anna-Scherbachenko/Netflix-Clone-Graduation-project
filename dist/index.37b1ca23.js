...
})({"hkEBQ":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "048d035f37b1ca23";
"use strict";
...
},{}],"8GrBN":[function(require,module,exports) {
// - imports
...
var _movieSingle = require("./movie-single");
...
function renderMovies(arr) {
    // вивід в HTML
    moviesList.innerHTML = (0, _moviesAll.moviesAll)(arr);
}
...
async function renderMovieInfo(movieId) {
    ...
    modalWindow.innerHTML = (0, _movieSingle.movieSingle)(result);
}
...
function onSearchInput(e) {
    ...
    if (e.target.value.length > 2) {
        ...
        Promise.all([
            api.getMoviesByKeyWords(e.target.value),
            api.getGenres()
        ...
        .then(([{ results: movies  }, { genres  }])=>{
            ...
            if (movies.length > 0) return addGenres(movies, genres);
        ...
        .then((result)=>renderMovies(result))//Якщо виконання будь-якої з "обіцянок" завершиться з помилкою, виконується метод catch(), який отримує об'єкт помилки та відображає повідомлення про помилку. У даному випадку виводиться повідомлення про помилку в консоль, а елемент з фідбеком відображається під інпутом.
        .catch((err)=>{
...
class ApiService {
    ...
    //utils
    sendRequest(url) {
        return fetch(url).then((res)=>this.checkResponse(res)).then((data)=>data).catch((err)=>{
...
},{}],"8JtWG":[function(require,module,exports) {
...
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "moviesAll", ()=>moviesAll);
const moviesAll = (arr)=>{
    // console.log('arr: ', arr);
    let output = "";
    arr.forEach((el)=>{
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"dbCqM":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "movieSingle", ()=>movieSingle);
const movieSingle = (obj)=>{
    ...
    return `<div class="modal-wrapper">
        ...
        <div class="modal-right">
            ...
            <p class="">Жанри:</p>
            <p>${genres.map((el)=>el.name).join("</span>, ")}</p></div>
...
function onBackDropClick(e) {
    if (e.target === e.currentTarget) closeModalWindow();
}
...
exports.default = openModalWindow;

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"eUcYU":[function(require,module,exports) {
...
},{}]},["hkEBQ","8GrBN"], "8GrBN", "parcelRequire716c")

//# sourceMappingURL=index.37b1ca23.js.map
